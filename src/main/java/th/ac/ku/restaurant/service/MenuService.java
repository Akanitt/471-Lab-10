...
public class MenuService {
    ...
    public List<MenuDto> getMenus() {
        ...
        ResponseEntity<MenuDto[]> response = restTemplate.exchange(url, HttpMethod.GET, entity, MenuDto[].class);
    ...
    public MenuDto addMenu(MenuDto menu) {
        ...
        ResponseEntity<MenuDto> response = restTemplate.exchange(url, HttpMethod.POST, entity, MenuDto.class);
